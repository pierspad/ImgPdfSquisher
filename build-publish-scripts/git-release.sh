...
echo -e "${BLUE}🚀 imgpdfsquisher Release Creator${NC}"
echo "=================================="
...
gh release create "$VERSION" \
    --target main \
    --title "imgpdfsquisher $VERSION" \
    --notes-file "$RELEASE_NOTES_FILE" \
    --generate-notes

echo -e "${GREEN}✅ Release $VERSION creato con successo!${NC}"
echo -e "${BLUE}🔗 Visualizza il release: https://github.com/pierspad/imgpdfsquisher/releases/tag/$VERSION${NC}"
