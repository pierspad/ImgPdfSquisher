...
COMPRESSION_MODES = {'auto': 'Rilevamento automatico del tipo di immagine', 'bw': 'Forza bianco e nero (1-bit PNG)', 'grayscale': 'Forza scala di grigi (JPEG)', 'color': 'Forza colori (JPEG)'}
